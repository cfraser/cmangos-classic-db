...
UPDATE `creature_ai_scripts` SET `action2_type`='22', `action2_param1`='1' WHERE `id`='524404';
UPDATE `creature_ai_scripts` SET `event_param1`='0', `event_param2`='15' WHERE `id`='524402';
